 ...
 * </pre>
 */
public class HashActivity extends BaseActivity implements View.OnClickListener {
    /**
     * 打开“哈希”模块
     *
     * @param context 上下文
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crypto_hash);
        bindEvent();
    }

    private void bindEvent() {
        ((TextView) findViewById(R.id.tv_title_bar_title)).setText(R.string.crypto_title_hash);
